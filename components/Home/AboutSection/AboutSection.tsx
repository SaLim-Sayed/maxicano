  ...
  return (
    <Center>
      <Head
        title="حول الشركة"
        subTitle={
          "تأسست شركة افريكانو عام 2015 كمشروع مشترك بين مجموعة مستثمرين أجانب لهم تاريخ عريق في مجال طحن الذرة واستخراج أفضل أنواع الدقيق والسومولينا والجر"
        }
      />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-4  w-full">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="text-justify">
            بخبرة واسعة في سوريا في مجال طحن القمح والذرة، تأسست شركة أفريكانو
            ...
            الطحن والتصنيع. هدفنا:الهدف الرئيسي لشركة أفريكانو هو دخول السوق
